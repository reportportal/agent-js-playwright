### Fixed
- [#56](https://github.com/reportportal/agent-js-playwright/issues/56), [#57](https://github.com/reportportal/agent-js-playwright/issues/57)
Error (can not read property of undefined 'rootSuit') when the user runs demo-tests generated by Playwright itself.
### Added
