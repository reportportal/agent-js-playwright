...
| launchId                                    | (optional) *Default: not set.* The _ID_ of an already existing launch. The launch must be in "IN_PROGRESS status while the tests are running. Please note that if this _ID_ is provided, the launch will not be finished at the end of the run and must be finished separately.                                                                                                                                      |
...
| uploadVideo                                 | (optional) *Default: true.* Whether to attach the Playwright's [video](https://playwright.dev/docs/api/class-testoptions#test-options-video) to the test case.                                                                                                                                                                                                                                                       |
| uploadTrace                                  | (optional) *Default: true.* Whether to attach the Playwright's [trace](https://playwright.dev/docs/api/class-testoptions#test-options-trace) to the test case.                                                                                                                                                                                                                                                       |
